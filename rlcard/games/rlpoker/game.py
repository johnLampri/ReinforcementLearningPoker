...
from rlcard.games.rlpoker import Dealer
from rlcard.games.rlpoker import Player, PlayerStatus
from rlcard.games.rlpoker import Judger
from rlcard.games.rlpoker import Round
...
class rlpokerGame:
    def __init__(self, allow_step_back=False, num_players=2):
        ...
        self.raise_amount = self.small_blind
    ...
    def init_game(self):
        ...
        self.players[b].in_chips =  self.small_blind   #changed 
    ...
    def get_payoffs(self):
        ...
        payoffs = np.array(chips_payoffs) / self.small_blind
        return payoffs
